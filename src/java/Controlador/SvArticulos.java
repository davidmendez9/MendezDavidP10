...
public class SvArticulos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Equipo e1 = (Equipo) miSesion.getAttribute("equipo");
        int codEquipo = e1.getCodigo_equipo();
        if(e1 != null)
        {
            ArrayList<Jugador> listaJugadores = new ArrayList();
            try {
                e1 = ConsultaEquipo.getEquipoActualizado(codEquipo);
                listaJugadores = ConsultaEquipo.listaJugadores(e1.getCodigo_equipo());
            } catch (SQLException ex) {
                Logger.getLogger(SvArticulos.class.getName()).log(Level.SEVERE, null, ex);
            }
